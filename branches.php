...
?>
    ...
    <section class="content-header">
      <h1 style="margin-bottom: 30px;">
          <a class="btn btn-lg btn-primary" href="#add" data-target="#addBranchModal" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-white"></i> Add New Branch</a>
      </h1>
      <ol class="breadcrumb">
